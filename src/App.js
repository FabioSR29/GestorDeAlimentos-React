...
function App() {
  ...
  function MuestreModalBorrar(Producto) {
    setProductoABorrar(Producto)
    setBorrar(true)

  }
  function CiereModalBorrar() {
    setBorrar(false)
        ...
        <div className='Cuerpo'>
          {ListaFiltrada.map((item, index) => (
            ...
            <div key={index}>
              ...
              <CartaDeProducto Producto={item} ListaDeAlimentos={ListaDeAlimentos} MuestreModalBorrar={MuestreModalBorrar} EditeElProducto={EditeElProducto} MuestreModalEditar={MuestreModalEditar} index={index}></CartaDeProducto>
        ...
        <Modal>
          <div className='Formulario'>
            ...
            <div className='FormularioBotones'>
              <button onClick={() => { BorreElProducto(ProductoABorrar) }} className='FormularioBoton'>Si</button>
              <button onClick={() => { CiereModalBorrar() }}className='FormularioBoton colorRojo'>No</button>
            </div>
          </div>
        </Modal>
      }
  ...
  return (
    <div className='Productos'>
      ...
      <div className='ProductoBotones'>
        <button onClick={() => { Propiedades.MuestreModalBorrar(Producto) }} className='btnBorrar'>
